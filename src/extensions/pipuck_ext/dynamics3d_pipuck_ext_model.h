...
namespace argos {
   ...
   private:
      ...
      static const btVector3 m_cMountHalfExtents;
      static const btScalar m_fMountMass;
      static const btTransform m_cMountOffset;
      static const btTransform m_cMountGeometricOffset;
      static const btScalar m_fMountFriction;
      static const btQuaternion m_cBodyToMountJointRotation;
      static const btVector3 m_cBodyToMountJointOffset;
      static const btVector3 m_cMountToBodyJointOffset;
   };
}
